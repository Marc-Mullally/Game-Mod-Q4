...
class rvMonsterHarvesterBoss : public idAI {
public:

	CLASS_PROTOTYPE(rvMonsterHarvesterBoss);

	rvMonsterHarvesterBoss(void);
...
private:
	...
	CLASS_STATES_PROTOTYPE(rvMonsterHarvesterBoss);
};

CLASS_DECLARATION(idAI, rvMonsterHarvesterBoss)
END_CLASS

/*
================
rvMonsterHarvesterBoss::rvMonsterHarvesterBoss
================
*/
rvMonsterHarvesterBoss::rvMonsterHarvesterBoss(void) {
}

void rvMonsterHarvesterBoss::InitSpawnArgsVariables(void)
{
...
/*
================
rvMonsterHarvesterBoss::Spawn
================
*/
void rvMonsterHarvesterBoss::Spawn(void) {
	// Custom actions
...
/*
================
rvMonsterHarvesterBoss::Save
================
*/
void rvMonsterHarvesterBoss::Save(idSaveGame* savefile) const {
...
/*
================
rvMonsterHarvesterBoss::Restore
================
*/
void rvMonsterHarvesterBoss::Restore(idRestoreGame* savefile) {
...
/*
================
rvMonsterHarvesterBoss::UpdateAnimationControllers
================
*/
bool rvMonsterHarvesterBoss::UpdateAnimationControllers(void) {
	idVec3 origin;
	idMat3 axis;
	idVec3 dir;
	idVec3 localDir;
...
/*
=====================
rvMonsterHarvesterBoss::SkipImpulse
=====================
*/
bool rvMonsterHarvesterBoss::SkipImpulse(idEntity* ent, int id) {
	return immuneToImpulse;
}

void rvMonsterHarvesterBoss::DropLeg(int part)
{
...
void rvMonsterHarvesterBoss::DestroyPart(int part)
{
	idStr explodeFX;
	idStr trailFX;
	switch (part)
...
/*
================
rvMonsterHarvesterBoss::CanTurn
================
*/
bool rvMonsterHarvesterBoss::CanTurn(void) const {
	if (!idAI::CanTurn()) {
		return false;
	}
...
/*
=====================
rvMonsterHarvesterBoss::GetDamageForLocation
=====================
*/
int rvMonsterHarvesterBoss::GetDamageForLocation(int damage, int location) {
...
/*
================
rvMonsterHarvesterBoss::Damage
================
*/
void rvMonsterHarvesterBoss::Damage(idEntity* inflictor, idEntity* attacker, const idVec3& dir,
...
/*
================
rvMonsterHarvesterBoss::CheckAction_SprayAttack
================
*/
bool rvMonsterHarvesterBoss::CheckAction_SprayAttack(rvAIAction* action, int animNum)
{
...
/*
================
rvMonsterHarvesterBoss::CheckAction_RocketAttack
================
*/
bool rvMonsterHarvesterBoss::CheckAction_RocketAttack(rvAIAction* action, int animNum)
{
	if (!enemy.ent) {
		return false;
	}
...
/*
================
rvMonsterHarvesterBoss::CheckAction_GrenadeAttack
================
*/
bool rvMonsterHarvesterBoss::CheckAction_GrenadeAttack(rvAIAction* action, int animNum)
{
...
/*
================
rvMonsterHarvesterBoss::CheckAction_WhipAttack
================::
*/
bool rvMonsterHarvesterBoss::CheckAction_WhipAttack(rvAIAction* action, int animNum) {
	if (!enemy.ent) {
		return false;
	}
	return true;
...
/*
================
rvMonsterHarvesterBoss::CheckAction_MeleeAttack
================
*/
bool rvMonsterHarvesterBoss::CheckAction_MeleeAttack(rvAIAction* action, int animNum) {
...
================
*/
bool rvMonsterHarvesterBoss::CheckAction_RangedAttack(rvAIAction* action, int animNum) {
	return (idAI::CheckAction_RangedAttack(action, animNum) && enemy.ent && GetRangedAttackAnim(enemy.ent->GetEyePosition()));
}

/*
================
rvMonsterHarvesterBoss::CheckActions
================
*/
bool rvMonsterHarvesterBoss::CheckActions(void) {
	...
	if (PerformAction(&actionRocketAttack, (checkAction_t)&rvMonsterHarvesterBoss::CheckAction_RocketAttack, &actionTimerRangedAttack)) {
		return true;
	}
...
/*
================
rvMonsterHarvesterBoss::FilterTactical
================
*/
int rvMonsterHarvesterBoss::FilterTactical(int availableTactical) {
...
CLASS_STATES_DECLARATION(rvMonsterHarvesterBoss)
STATE("State_Killed", rvMonsterHarvesterBoss::State_Killed)
STATE("State_Dead", rvMonsterHarvesterBoss::State_Dead)

STATE("Torso_WhipAttack", rvMonsterHarvesterBoss::State_Torso_WhipAttack)
STATE("Torso_ClawAttack", rvMonsterHarvesterBoss::State_Torso_ClawAttack)
STATE("Torso_RangedAttack", rvMonsterHarvesterBoss::State_Torso_RangedAttack)
STATE("Torso_TurnRight90", rvMonsterHarvesterBoss::State_Torso_TurnRight90)
...
/*
================
rvMonsterHarvesterBoss::State_Killed
================
*/
stateResult_t rvMonsterHarvesterBoss::State_Killed(const stateParms_t& parms) {
...
/*
================
rvMonsterHarvesterBoss::State_Dead
================
*/
stateResult_t rvMonsterHarvesterBoss::State_Dead(const stateParms_t& parms) {
...
/*
================
rvMonsterHarvesterBoss::State_Torso_WhipAttack
================
*/
...
/*
=====================
rvMonsterHarvesterBoss::Attack
=====================
*/
bool rvMonsterHarvesterBoss::Attack(const char* attackName, jointHandle_t joint, idEntity* target, const idVec3& pushVelocity) {
...
/*
================
rvMonsterHarvesterBoss::GetMeleeAttackAnim
================
*/
const char* rvMonsterHarvesterBoss::GetMeleeAttackAnim(const idVec3& target) {
	idVec3 		dir;
	idVec3 		localDir;
	float  		yaw;
	const char* animName;
...
/*
================
rvMonsterHarvesterBoss::PlayMeleeAttackAnim
================
*/
...
/*
================
rvMonsterHarvesterBoss::GetRangedAttackAnim
================
*/
const char* rvMonsterHarvesterBoss::GetRangedAttackAnim(const idVec3& target) {
	idVec3 		dir;
	idVec3 		localDir;
	float  		yaw;
...
/*
================
rvMonsterHarvesterBoss::PlayRangedAttackAnim
================
*/
bool rvMonsterHarvesterBoss::PlayRangedAttackAnim(const idVec3& target, int blendFrames) {
...
/*
================
rvMonsterHarvesterBoss::State_Torso_ClawAttack
================
*/
...
/*
================
rvMonsterHarvesterBoss::State_Torso_TurnRight90
================
*/
...
/*
================
rvMonsterHarvesterBoss::State_Torso_TurnLeft90
================
*/
...
/*
================
rvMonsterHarvesterBoss::State_Torso_SprayAttack
================
*/
...
/*
================
rvMonsterHarvesterBoss::State_Torso_RocketAttack
================
*/
